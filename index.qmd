...
```{r echo = F}
table_cases <- tribble(
  ~Name, ~Link, ~Language, ~Tool, ~Location, ~Scale, ~Disease, ~Keywords, ~Technical_Complexity, ~Methodological_Complexity,
  "Fulton", 'pages/fulton-en.html', "English", "R", "United States", "Local", "COVID-19", "COVID-19; SARS-COV-2; Outbreak", "Intermediate", "Basic",  
  "Oswego ES", "pages/oswego-es.html", "Español", "R", "Estados Unidos", "Local", "Gastrointestinal", "Gastrointestinal;Brote", "Intermedio", "Intermedio"
)
