...
## Structure
If your case study is long, consider it dividing it into different parts and separate the layout with tabs using the "::: {.panel-tabset}" option. More information on how to create a tab separted layout with Quarto can be found in this [link](https://quarto.org/docs/interactive/layout.html)
