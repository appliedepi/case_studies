...
<!-- This is a Template that can be used to create an R case study 
<!--In line 8 insert the name of the Case study. In curly brackets is the section reference name to be cross-references throughout the quarto book -->
