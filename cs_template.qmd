...
### Structure
If your case study is long, consider it dividing it into different parts and separate the layout with tabs using the "::: {.panel-tabset}" option. More information on how to create a tab separated layout with Quarto can be found in the section "Tabset Panel" on this website: [link](https://quarto.org/docs/interactive/layout.html)
