...
Enumere una de las grandes categorías de agentes causales de
enfermedades que se deben considerar en el diagnóstico diferencial de un
brote de enfermedad gastrointestinal como el de Oswego:\
...
`r fontawesome::fa("check", fill = "red")`Click para ver la explicación
de la solución (¡Inténtelo usted primero!)
...
En lenguaje epidemiológico, ¿Qué es un vehículo? ¿Qué es un vector?
¿Cuáles son otros modos?
...
Si fuese usted el que administra el cuestionario, ¿qué información
recopilaría? Agrupa la información en categorías. Una vez que haya
escrito sus categorías, puede ver abajo la solución.
...
**Por favor, continue el caso entrando en la pestaña "Segunda parte - El
Evento" en la parte superior**
...
¿Cuál es el valor de una curva epidémica en la investigación de un
brote?
...
oswego_db <- import("../case_studies_to_translate/ESP/oswego_cs_es/data/oswego.xlsx")
...
¿Hay algún caso en el que los tiempos de inicio no coincidan con los
generales? ¿experiencia? ¿Cómo podrían explicarse?
...
¿Cómo podrían presentarse mejor los datos en el listado nominal de
participantes?
