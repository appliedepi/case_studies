...
-   I need to clean up the disease names so that e.g. is "Yellow Fever" 
    and not yellow_fever - will do that in the original data (AJ fixed this in the data)
...
-   Add make-believe map? (You already did this!)
-   Need to decide on case study information/license stuff below (updated the section below based off of Alex's recommendations)
