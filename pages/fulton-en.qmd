...
```{r , echo=TRUE, eval=FALSE}
### **Step 3.3: Clean names and remove duplicated rows** {.unnumbered}
...
*   Transform the column **case_age** into numeric
*   Mark as missing those with negative ages
...
*   Contain a category "Hispanic, all races" when **case_eth** is "HISPANIC/LATINO". For those cases where this condition is not met: 
      ...
      *   Ensure all categories have consisent cases
