...
### **Step 3.2: Clean names and remove duplicated rows** {.unnumbered}
Clean the column names ensuring that names do not contain special characters and remove rows that have duplicated information on: patient id, gender and date of birth. 
...
### **Step 3.3: Clean dates** {.unnumbered}
...
c) Create a column named "epiweek" using the report date which rounds the report date to the nearest week, taking "Wednesday" as the start of the week.
...
### **Step 3.4: Clean other columns** {.unnumbered}
...
### **Step 3.5: Filter data frame** {.unnumbered}
